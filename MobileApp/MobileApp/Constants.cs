namespace MobileApp
{
    internal static class Constants
    {
        ...
        public const string TasksAddress = "http://diplom.std-918.ist.mospolytech.ru/api/get_user_by_name/";
        public const string GetUserIdAddress = "http://diplom.std-918.ist.mospolytech.ru/api/tasks/";
